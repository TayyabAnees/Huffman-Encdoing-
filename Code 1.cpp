...
int main()
{
	...
	for (int a = 0; a < v.size(); a++)
	{
		item.push_back(v[a]->data);
		freq.push_back(v[a]->frequency);
		cout << v[a]->data << " ";
		cout << v[a]->frequency;
		cout << endl;
	}
	Huffman<char> obj;
	node<char>* text_root=obj.Huffman_Codes(item, freq, item.size());
...
//Part 2 for converting Binary to compressed binary
//#include<iostream>
//#include <vector>
//#include<string>
//#include<fstream>
